# UNTESTED Template for deploying k3s backed by Flux

Highly opinionated *untested* template for deploying a single [k3s](https://k3s.io) cluster with [Ansible](https://www.ansible.com) and [Terraform](https://www.terraform.io) backed by [Flux](https://toolkit.fluxcd.io/) and [SOPS](https://toolkit.fluxcd.io/guides/mozilla-sops/).
...
#### Latest sync commit
Aug 6, 2022 #426-#428 https://github.com/k8s-at-home/flux-cluster-template/commits/main
...
- [Ansible](https://www.ansible.com) - Provision Ubuntu Server and install k3s
